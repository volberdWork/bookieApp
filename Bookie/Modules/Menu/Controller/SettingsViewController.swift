...
extension SettingsViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 2{
            if indexPath.row == 0{
                openTermsScreen(text: TextTerms().policyText)
            } else{
                openTermsScreen(text: TextTerms().termsTex)
            }
        }
...
struct TextTerms{
    ...
    Application means the software program provided by the Company downloaded by You on any electronic device, named KTO
    ...
    Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
        ...
        Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to KTO.
...
Application refers to KTO, the software program provided by the Company.
